...
class TrainConfig:
    ...
    def __init__(self, params, param_scheduler, output_dir) -> None:
        ...
        # AttrDict is a function that can read json file of parameters specification
        # the parameter json is put under output directory
    ...
    def train(self):
        ...
        # Here will create a new DiffproLearner
